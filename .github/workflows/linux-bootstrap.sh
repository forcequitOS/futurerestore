...
ln -sf /usr/bin/clang++-15 /usr/bin/clang++
curl -skO https://cdn.cryptiiiic.com/bootstrap/linux_fix.tar.zst &
curl -skO https://cdn.cryptiiiic.com/deps/static/Linux/x86_64/Linux_x86_64_Release_Latest.tar.zst &
curl -skO https://cdn.cryptiiiic.com/deps/static/Linux/x86_64/Linux_x86_64_Debug_Latest.tar.zst &
